/*
 * Code for class RESIZABLE [INTEGER_64]
 */
...
extern EIF_TYPED_VALUE F713_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F713_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F713_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F713_3707(EIF_REFERENCE);
extern void F713_3708(EIF_REFERENCE);
extern void F713_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F713_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F713_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F713_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 712, Current, 0, 0, 5128);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(712, Current, 5128);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F713_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 712, Current, 0, 0, 5129);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(712, Current, 5129);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F713_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 712, Current, 0, 0, 5130);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(712, Current, 5130);
	RTIV(Current, RTAL);
...
void F713_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 712, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
