...
extern void F466_3654(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F466_3654 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 465, Current, 0, 1, 4916);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(465, Current, 4916);
	RTCC(arg1, 465, l_feature_name, 1, RTWCT(3037, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
