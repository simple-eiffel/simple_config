/*
 * Code for class RESIZABLE [NATURAL_32]
 */
...
extern EIF_TYPED_VALUE F631_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F631_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F631_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F631_3707(EIF_REFERENCE);
extern void F631_3708(EIF_REFERENCE);
extern void F631_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F631_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F631_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F631_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 630, Current, 0, 0, 5116);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(630, Current, 5116);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F631_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 630, Current, 0, 0, 5117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(630, Current, 5117);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F631_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 630, Current, 0, 0, 5118);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(630, Current, 5118);
	RTIV(Current, RTAL);
...
void F631_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 630, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
