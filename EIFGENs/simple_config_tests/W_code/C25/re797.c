...
extern EIF_TYPED_VALUE F797_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F797_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F797_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F797_3707(EIF_REFERENCE);
extern void F797_3708(EIF_REFERENCE);
extern void F797_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F797_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F797_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F797_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 5140);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 5140);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F797_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 5141);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 5141);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F797_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 5142);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 5142);
	RTIV(Current, RTAL);
...
void F797_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 796, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
