...
extern EIF_TYPED_VALUE F224_4724(EIF_REFERENCE);
extern void F224_7368(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F224_4724 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 223, Current, 0, 0, 9094);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(223, Current, 9094);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F224_7368 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 223, Current, 0, 7367);
	RTSA(dtype);
	RTME(dtype, 0);
