...
extern EIF_TYPED_VALUE F225_4774(EIF_REFERENCE);
extern EIF_TYPED_VALUE F225_4775(EIF_REFERENCE);
extern EIF_TYPED_VALUE F225_4776(EIF_REFERENCE);
extern EIF_TYPED_VALUE F225_4778(EIF_REFERENCE);
extern void F225_4783(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F225_4774 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(3832,Dtype(Current)));
	return r;
}


/* {RT_DBG_VALUE_RECORD}.type */
EIF_TYPED_VALUE F225_4775 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F225_4776 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(3834,Dtype(Current)));
	return r;
}


/* {RT_DBG_VALUE_RECORD}.debug_output */
EIF_TYPED_VALUE F225_4778 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 224, Current, 0, 0, 9849);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(224, Current, 9849);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F225_4783 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 224, Current, 0, 1, 9850);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(224, Current, 9850);
	RTCC(arg1, 224, l_feature_name, 1, RTWCT(3834, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 3834, 0xF80000E5, 0); /* breakable_info */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(3834, dtype)) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
