...
extern EIF_TYPED_VALUE F336_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F336_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F336_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F336_3707(EIF_REFERENCE);
extern void F336_3708(EIF_REFERENCE);
extern void F336_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F336_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F336_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F336_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 335, Current, 0, 0, 5074);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(335, Current, 5074);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F336_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 335, Current, 0, 0, 5075);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(335, Current, 5075);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F336_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 335, Current, 0, 0, 5076);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(335, Current, 5076);
	RTIV(Current, RTAL);
...
void F336_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 335, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
