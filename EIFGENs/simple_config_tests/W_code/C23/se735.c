...
extern EIF_TYPED_VALUE F735_3646(EIF_REFERENCE);
...
EIF_TYPED_VALUE F735_3646 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 734, Current, 0, 0, 4912);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(734, Current, 4912);
	RTIV(Current, RTAL);
	RTHOOK(1);
