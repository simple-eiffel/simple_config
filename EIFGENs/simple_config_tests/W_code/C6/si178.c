/*
 * Code for class SIMPLE_JSON_PATCH_COPY
 */
...
extern void F178_2682(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F178_2683(EIF_REFERENCE);
extern EIF_TYPED_VALUE F178_2684(EIF_REFERENCE);
extern EIF_TYPED_VALUE F178_2685(EIF_REFERENCE);
extern EIF_TYPED_VALUE F178_2686(EIF_REFERENCE);
extern EIF_TYPED_VALUE F178_2687(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SIMPLE_JSON_PATCH_COPY}.make */
void F178_2682 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 177, Current, 0, 2, 2688);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(177, Current, 2688);
	RTCC(arg1, 177, l_feature_name, 1, eif_new_type(280, 0x01), 0x01);
	RTCC(arg2, 177, l_feature_name, 2, eif_new_type(280, 0x01), 0x01);
	RTIV(Current, RTAL);
...
/* {SIMPLE_JSON_PATCH_COPY}.op */
RTOID (F178_2683)
EIF_TYPED_VALUE F178_2683 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 177, Current, 0, 0, 2689);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(177, Current, 2689);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
/* {SIMPLE_JSON_PATCH_COPY}.is_valid */
EIF_TYPED_VALUE F178_2684 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 177, Current, 1, 0, 2690);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(177, Current, 2690);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SIMPLE_JSON_PATCH_COPY}.requires_value */
EIF_TYPED_VALUE F178_2685 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {SIMPLE_JSON_PATCH_COPY}.requires_from */
EIF_TYPED_VALUE F178_2686 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {SIMPLE_JSON_PATCH_COPY}.apply */
EIF_TYPED_VALUE F178_2687 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 177, Current, 5, 1, 2693);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(177, Current, 2693);
	RTCC(arg1, 177, l_feature_name, 1, eif_new_type(90, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if (EIF_TEST(loc3)) {
		...
		if (tb1) {
			...
			if (EIF_TEST(loc4)) {
				...
				if (EIF_TEST(loc5)) {
					...
					ur1 = RTCCL(arg1);
					tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2417, "apply", loc5))(loc5, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		...
		RTDBGAL(0, 0xF8000008, 0,0); /* Result */
		tr1 = RTLN(eif_new_type(8, 0x01).id);
		tr2 = RTMS_EX_H("No from path specified for copy operation",41,763244142);
		tr3 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4807, "as_string_32", tr2))(tr2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr3);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(122, Dtype(tr1)))(tr1, ur1x);
		RTNHOOK(13,1);
...
/* {SIMPLE_JSON_PATCH_COPY}._invariant */
...
#define up1 up1x.it_p
	...
	RTLU (SK_REF, &Current);
	RTLU(SK_REF, &loc1);
	RTEAINV(l_feature_name, 177, Current, 1, 7326);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("copy_not_requires_value", Current);
