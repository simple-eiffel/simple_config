/*
 * Code for class SIMPLE_JSON_PATCH_REPLACE
 */
...
extern void F181_2701(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F181_2702(EIF_REFERENCE);
extern EIF_TYPED_VALUE F181_2703(EIF_REFERENCE);
extern EIF_TYPED_VALUE F181_2704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F181_2705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F181_2706(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F181_7330(EIF_REFERENCE, int);
...
/* {SIMPLE_JSON_PATCH_REPLACE}.make */
void F181_2701 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 180, Current, 0, 2, 2709);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(180, Current, 2709);
	RTCC(arg1, 180, l_feature_name, 1, eif_new_type(280, 0x01), 0x01);
	RTCC(arg2, 180, l_feature_name, 2, eif_new_type(90, 0x01), 0x01);
	RTIV(Current, RTAL);
...
/* {SIMPLE_JSON_PATCH_REPLACE}.op */
RTOID (F181_2702)
EIF_TYPED_VALUE F181_2702 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 180, Current, 0, 0, 2710);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(180, Current, 2710);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
/* {SIMPLE_JSON_PATCH_REPLACE}.is_valid */
EIF_TYPED_VALUE F181_2703 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 180, Current, 0, 0, 2711);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(180, Current, 2711);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SIMPLE_JSON_PATCH_REPLACE}.requires_value */
EIF_TYPED_VALUE F181_2704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {SIMPLE_JSON_PATCH_REPLACE}.requires_from */
EIF_TYPED_VALUE F181_2705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {SIMPLE_JSON_PATCH_REPLACE}.apply */
EIF_TYPED_VALUE F181_2706 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 180, Current, 4, 1, 2714);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(180, Current, 2714);
	RTCC(arg1, 180, l_feature_name, 1, eif_new_type(90, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
	...
	if (tb1) {
		...
		if (tb1) {
			...
			if (EIF_TEST(loc4)) {
				...
				ur1 = RTCCL(arg1);
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2417, "apply", loc4))(loc4, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				Result = (EIF_REFERENCE) RTCCL(tr1);
			} else {
				RTHOOK(9);
				RTDBGAL(0, 0xF8000008, 0,0); /* Result */
				tr1 = RTLN(eif_new_type(8, 0x01).id);
				tr2 = RTMS_EX_H("Internal error in replace operation",35,517698926);
			...
			RTDBGAL(0, 0xF8000008, 0,0); /* Result */
			tr1 = RTLN(eif_new_type(8, 0x01).id);
			tr2 = RTMS_EX_H("Target does not exist at path: ",31,726863648);
...
/* {SIMPLE_JSON_PATCH_REPLACE}._invariant */
void F181_7330 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 180, Current, 0, 7329);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("replace_not_requires_from", Current);
