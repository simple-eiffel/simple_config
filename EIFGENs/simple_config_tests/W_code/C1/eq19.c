...
extern void F19_347(EIF_REFERENCE);
extern void F19_348(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F19_349(EIF_REFERENCE);
extern EIF_TYPED_VALUE F19_350(EIF_REFERENCE);
extern EIF_TYPED_VALUE F19_351(EIF_REFERENCE);
...
void F19_347 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 18, Current, 0, 0, 348);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(18, Current, 348);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		RTHOOK(1);
		RTCT("not_exceptional", EX_POST);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(350, dtype))(Current)).it_b);
		if ((EIF_BOOLEAN) !tb1) {
			RTCK;
		} else {
			RTCF;
...
void F19_348 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 18, Current, 0, 1, 349);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(18, Current, 349);
	RTCC(arg1, 18, l_feature_name, 1, RTWCT(348, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 349, 0xF8000131, 0); /* internal_exception */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F19_349 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 18, Current, 0, 0, 350);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(18, Current, 350);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F19_350 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F19_351 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 18, Current, 0, 0, 352);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
