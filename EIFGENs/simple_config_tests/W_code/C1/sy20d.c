...
static const EIF_TYPE_INDEX egt_0_20 [] = {0xFF01,277,0xFFFF};
static const EIF_TYPE_INDEX egt_1_20 [] = {0xFF01,308,19,0xFFFF};
...
static const EIF_TYPE_INDEX egt_8_20 [] = {0xFF01,22,0xFFFF};
static const EIF_TYPE_INDEX egt_9_20 [] = {0xFF01,277,0xFFFF};
static const EIF_TYPE_INDEX egt_10_20 [] = {0xFF01,277,0xFFFF};
...
static const struct desc_info desc_20[] = {
	...
	{EIF_NON_GENERIC(0x01F9 /*252*/), 354, 0xFFFFFFFF},
};
void Init20(void)
{
	IDSC(desc_20, 0, 19);
	IDSC(desc_20 + 1, 4, 19);
	IDSC(desc_20 + 32, 103, 19);
}
