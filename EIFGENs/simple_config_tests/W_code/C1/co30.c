...
extern EIF_TYPED_VALUE F30_663(EIF_REFERENCE);
extern EIF_TYPED_VALUE F30_664(EIF_REFERENCE);
extern EIF_TYPED_VALUE F30_665(EIF_REFERENCE);
extern EIF_TYPED_VALUE F30_666(EIF_REFERENCE);
...
RTOID (F30_663)
EIF_TYPED_VALUE F30_663 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 29, Current, 0, 0, 743);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(29, Current, 743);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(3693, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
	...
	tr1 = RTMS_EX_H("65000",5,892765232);
	ur1 = tr1;
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(305, 14))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur2 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(3172, "put", Result))(Result, ur1x, ur2x);
	RTHOOK(153);
...
RTOID (F30_664)
EIF_TYPED_VALUE F30_664 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 29, Current, 0, 0, 744);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(29, Current, 744);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000397, 0,0); /* Result */
...
RTOID (F30_665)
EIF_TYPED_VALUE F30_665 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 29, Current, 0, 0, 745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(29, Current, 745);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000397, 0,0); /* Result */
...
RTOID (F30_666)
EIF_TYPED_VALUE F30_666 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 29, Current, 0, 0, 746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(29, Current, 746);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000397, 0,0); /* Result */
