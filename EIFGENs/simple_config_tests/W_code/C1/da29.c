...
extern EIF_TYPED_VALUE F29_655(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_656(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_657(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_658(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_659(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_660(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_661(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_662(EIF_REFERENCE);
...
EIF_TYPED_VALUE F29_655 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F29_655,736,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F29_656)
EIF_TYPED_VALUE F29_656 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 28, Current, 0, 0, 736);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(28, Current, 736);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {394,0xFF01,277,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F29_657)
EIF_TYPED_VALUE F29_657 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 28, Current, 0, 0, 737);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(28, Current, 737);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000187, 0,0); /* Result */
...
RTOID (F29_658)
EIF_TYPED_VALUE F29_658 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 28, Current, 0, 0, 738);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(28, Current, 738);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000187, 0,0); /* Result */
...
RTOID (F29_659)
EIF_TYPED_VALUE F29_659 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 28, Current, 0, 0, 739);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(28, Current, 739);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000187, 0,0); /* Result */
...
EIF_TYPED_VALUE F29_660 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F29_660,741,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F29_661 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F29_661,742,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F29_662 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F29_662,743,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
