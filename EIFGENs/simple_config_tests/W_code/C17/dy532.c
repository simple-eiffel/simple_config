...
extern EIF_TYPED_VALUE F532_4236(EIF_REFERENCE);
extern void F532_4242(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F532_4243(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F532_4246(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F532_4247(EIF_REFERENCE);
extern EIF_TYPED_VALUE F532_4248(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F532_4236 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 531, Current, 0, 0, 7006);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(531, Current, 7006);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DYNAMIC_CHAIN}.prune */
void F532_4242 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 531, Current, 0, 1, 7007);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(531, Current, 7007);
	RTIV(Current, RTAL);
...
void F532_4243 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 531, Current, 0, 1, 7008);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(531, Current, 7008);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		uc1 = arg1;
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3131, dtype))(Current, uc1x)).it_b);
		if ((EIF_BOOLEAN) !tb2) {
			RTCK;
		} else {
			RTCF;
...
void F532_4246 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 531, Current, 3, 1, 7009);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(531, Current, 7009);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F532_4247 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 531, Current, 0, 0, 7004);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(531, Current, 7004);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F532_4248 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 531, Current, 2, 1, 7005);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(531, Current, 7005);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
