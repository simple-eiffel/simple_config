...
extern EIF_TYPED_VALUE F554_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F554_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F554_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F554_3707(EIF_REFERENCE);
extern void F554_3708(EIF_REFERENCE);
extern void F554_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F554_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F554_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F554_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 553, Current, 0, 0, 5104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(553, Current, 5104);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F554_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 553, Current, 0, 0, 5105);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(553, Current, 5105);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F554_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 553, Current, 0, 0, 5106);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(553, Current, 5106);
	RTIV(Current, RTAL);
...
void F554_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 553, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
