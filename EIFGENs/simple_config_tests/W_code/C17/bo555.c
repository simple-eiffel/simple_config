/*
 * Code for class BOUNDED [CHARACTER_32]
 */
...
extern EIF_TYPED_VALUE F555_3702(EIF_REFERENCE);
extern void F555_7348(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F555_3702 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 554, Current, 0, 0, 5052);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(554, Current, 5052);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F555_7348 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 554, Current, 0, 7347);
	RTSA(dtype);
	RTME(dtype, 0);
