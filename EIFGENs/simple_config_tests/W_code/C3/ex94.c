...
extern EIF_TYPED_VALUE F94_1503(EIF_REFERENCE);
...
RTOID (F94_1503)
EIF_TYPED_VALUE F94_1503 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 93, Current, 0, 0, 1524);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(93, Current, 1524);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
