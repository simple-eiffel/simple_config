...
extern void F374_3654(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F374_3654 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 373, Current, 0, 1, 4914);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(373, Current, 4914);
	RTCC(arg1, 373, l_feature_name, 1, RTWCT(3037, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
