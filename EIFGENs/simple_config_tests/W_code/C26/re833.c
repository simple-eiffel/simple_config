/*
 * Code for class RESIZABLE [INTEGER_8]
 */
...
extern EIF_TYPED_VALUE F833_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F833_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F833_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F833_3707(EIF_REFERENCE);
extern void F833_3708(EIF_REFERENCE);
extern void F833_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F833_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F833_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F833_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 832, Current, 0, 0, 5146);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(832, Current, 5146);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F833_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 832, Current, 0, 0, 5147);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(832, Current, 5147);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F833_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 832, Current, 0, 0, 5148);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(832, Current, 5148);
	RTIV(Current, RTAL);
...
void F833_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 832, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
