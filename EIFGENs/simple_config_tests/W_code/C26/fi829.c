...
extern EIF_TYPED_VALUE F829_3700(EIF_REFERENCE);
extern void F829_7347(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F829_3700 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 828, Current, 0, 0, 5036);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(828, Current, 5036);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F829_7347 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 828, Current, 0, 7346);
	RTSA(dtype);
	RTME(dtype, 0);
