...
extern EIF_TYPED_VALUE F868_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F868_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F868_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F868_3707(EIF_REFERENCE);
extern void F868_3708(EIF_REFERENCE);
extern void F868_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F868_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F868_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F868_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 867, Current, 0, 0, 5152);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(867, Current, 5152);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F868_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 867, Current, 0, 0, 5153);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(867, Current, 5153);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F868_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 867, Current, 0, 0, 5154);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(867, Current, 5154);
	RTIV(Current, RTAL);
...
void F868_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 867, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
