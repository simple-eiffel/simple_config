...
extern EIF_TYPED_VALUE F876_3629(EIF_REFERENCE);
extern void F876_3632(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F876_7344(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F876_3629 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 875, Current, 0, 0, 4861);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(875, Current, 4861);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F876_3632 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 875, Current, 0, 1, 4862);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(875, Current, 4862);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3156, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	uu2_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3148, 857))(Current, uu2_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F876_7344 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 875, Current, 0, 7343);
	RTSA(dtype);
	RTME(dtype, 0);
