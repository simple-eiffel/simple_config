...
extern EIF_TYPED_VALUE F398_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F398_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F398_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F398_3707(EIF_REFERENCE);
extern void F398_3708(EIF_REFERENCE);
extern void F398_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F398_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F398_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F398_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 397, Current, 0, 0, 5080);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(397, Current, 5080);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F398_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 397, Current, 0, 0, 5081);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(397, Current, 5081);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F398_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 397, Current, 0, 0, 5082);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(397, Current, 5082);
	RTIV(Current, RTAL);
...
void F398_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 397, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
