/*
 * Code for class RESIZABLE [REAL_64]
 */
...
extern EIF_TYPED_VALUE F676_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F676_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F676_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F676_3707(EIF_REFERENCE);
extern void F676_3708(EIF_REFERENCE);
extern void F676_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F676_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F676_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F676_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 675, Current, 0, 0, 5122);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 5122);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F676_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 675, Current, 0, 0, 5123);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 5123);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F676_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 675, Current, 0, 0, 5124);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 5124);
	RTIV(Current, RTAL);
...
void F676_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 675, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
