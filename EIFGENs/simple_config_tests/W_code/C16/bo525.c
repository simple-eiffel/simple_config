...
extern EIF_TYPED_VALUE F525_3702(EIF_REFERENCE);
extern void F525_7348(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F525_3702 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 524, Current, 0, 0, 5050);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 5050);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F525_7348 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 524, Current, 0, 7347);
	RTSA(dtype);
	RTME(dtype, 0);
