...
extern EIF_TYPED_VALUE F524_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F524_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F524_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F524_3707(EIF_REFERENCE);
extern void F524_3708(EIF_REFERENCE);
extern void F524_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F524_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F524_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F524_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 523, Current, 0, 0, 5098);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(523, Current, 5098);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F524_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 523, Current, 0, 0, 5099);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(523, Current, 5099);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F524_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 523, Current, 0, 0, 5100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(523, Current, 5100);
	RTIV(Current, RTAL);
...
void F524_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 523, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
