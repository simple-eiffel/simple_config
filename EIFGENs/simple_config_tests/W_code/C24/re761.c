/*
 * Code for class RESIZABLE [REAL_32]
 */
...
extern EIF_TYPED_VALUE F761_3704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F761_3705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F761_3706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F761_3707(EIF_REFERENCE);
extern void F761_3708(EIF_REFERENCE);
extern void F761_7349(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F761_3704 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F761_3705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F761_3706 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 760, Current, 0, 0, 5134);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 5134);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F761_3707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 760, Current, 0, 0, 5135);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 5135);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F761_3708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 760, Current, 0, 0, 5136);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 5136);
	RTIV(Current, RTAL);
...
void F761_7349 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 760, Current, 0, 7348);
	RTSA(dtype);
	RTME(dtype, 0);
