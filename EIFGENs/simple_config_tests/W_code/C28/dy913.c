...
extern EIF_TYPED_VALUE F913_4236(EIF_REFERENCE);
extern void F913_4242(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F913_4243(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F913_4246(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F913_4247(EIF_REFERENCE);
extern EIF_TYPED_VALUE F913_4248(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F913_4236 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 912, Current, 0, 0, 7066);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(912, Current, 7066);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DYNAMIC_CHAIN}.prune */
void F913_4242 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 912, Current, 0, 1, 7067);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(912, Current, 7067);
	RTIV(Current, RTAL);
...
void F913_4243 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 912, Current, 0, 1, 7068);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(912, Current, 7068);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		ub1 = arg1;
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3131, dtype))(Current, ub1x)).it_b);
		if ((EIF_BOOLEAN) !tb2) {
			RTCK;
		} else {
			RTCF;
...
void F913_4246 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 912, Current, 3, 1, 7069);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(912, Current, 7069);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3021, "item", loc3))(loc3)).it_b);
				ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3069, "target_index", loc3))(loc3)).it_i4);
...
void F913_4247 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 912, Current, 0, 0, 7064);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(912, Current, 7064);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F913_4248 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 912, Current, 2, 1, 7065);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(912, Current, 7065);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(3);
	RTDBGAL(0, 0xF8000390, 0,0); /* Result */
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3162, "extend", Result))(Result, ub1x);
		RTHOOK(9);
