...
extern void F1004_4461(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1004_4462(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1004_4463(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1004_4464(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1004_4465(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1004_4466(EIF_REFERENCE);
...
void F1004_4461 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1003, Current, 1, 1, 8381);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 8381);
	{
		...
		RTCC(arg1, 1003, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
void F1004_4462 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1003, Current, 0, 1, 8382);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 8382);
	RTCC(arg1, 1003, l_feature_name, 1, RTWCT(3176, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3579, dtype))(Current, ur1x);
	RTHOOK(2);
...
/* {ARRAYED_STACK}.put */
void F1004_4463 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1003, Current, 0, 1, 8383);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 8383);
	RTCC(arg1, 1003, l_feature_name, 1, RTWCT(3176, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {ARRAYED_STACK}.force */
void F1004_4464 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1003, Current, 0, 1, 8378);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 8378);
	RTCC(arg1, 1003, l_feature_name, 1, RTWCT(3176, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1004_4465 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 8379);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 8379);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(3580, dtype))(Current);
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(3154, dtype))(Current);
	RTVI(Current, RTAL);
	RTRS;
...
EIF_TYPED_VALUE F1004_4466 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1003, Current, 1, 0, 8380);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 8380);
	RTIV(Current, RTAL);
	RTHOOK(1);
