...
EIF_TYPED_VALUE F109_1573 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 108, Current, 0, 0, 1594);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(108, Current, 1594);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1580, 137))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 108, Current, 0, 0, 1595);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(108, Current, 1595);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
