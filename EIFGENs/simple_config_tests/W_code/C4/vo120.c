...
extern EIF_TYPED_VALUE F120_1595(EIF_REFERENCE);
extern EIF_TYPED_VALUE F120_1596(EIF_REFERENCE);
...
EIF_TYPED_VALUE F120_1595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 119, Current, 0, 0, 1616);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1569, 137))(Current)).it_i4);
...
RTOID (F120_1596)
EIF_TYPED_VALUE F120_1596 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 119, Current, 0, 0, 1617);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
